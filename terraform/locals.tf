locals {
  container_info          = jsondecode(file("${path.module}/files/container.json"))
  ...
  r2_bucket_public_domain     = cloudflare_r2_custom_domain.custom_domain.domain
  r2_bucket_public_url        = "https://${local.r2_bucket_public_domain}"
